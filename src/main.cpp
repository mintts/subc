...
// Copyright (c) 2017 The SubYuanChain developers
...
uint256 hashGenesisBlock("0x00000f2a2a8bbecc9690dc16dde5e4f87ff37e9fa32f495841a5adbaea46b044");
static const unsigned int timeGenesisBlock = 1521680400;
...
const string strMessageMagic = "SubYuanChain Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "March 22, 2018. The SubYuanChain release. ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040ae6300bdeb6ab0cccf67b537d923918a4cdd62375868f7873d47765a38d1d3660d7eab993916d31a2a9049891bc6356bc9b779e2d7ab4844d43ea6de7c26ed0") << OP_CHECKSIG;
        CBlock block;
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x4ad17841eed27df25dea25b2ee2ed8385eaafbed46de9563e54e0aa5e793814c"));
...
unsigned char pchMessageStart[4] = { 0xea, 0xf2, 0xdb, 0xcc };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("SubYuanChainMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("SubYuanChainMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("SubYuanChainMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("SubYuanChain-miner");
    ...
    try { loop {
        ...
        printf("Running SubYuanChainMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("SubYuanChainMiner terminated\n");
        throw;
    }
}

...
const QString BITCOIN_IPC_PREFIX("SubYuanChain:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click SubYuanChain: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start SubYuanChain: click-to-pay handler");
    else
...
{
    // clicking on SubYuanChain: URLs creates FileOpen events on the Mac:

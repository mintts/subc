...
/*These are platform-dependant and thus removed to avoid useless test failures
    ...
    BOOST_CHECK_EQUAL(DateTimeStrFormat("%Y-%m-%d %H:%M:%S", 1313235777), "2011-09-30 23:36:17");
    BOOST_CHECK_EQUAL(DateTimeStrFormat("%Y-%m-%d %H:%M", 1313235777), "2011-09-30 23:36");
*/
}
